<div class="container mx-auto p-10">
    ...
    @foreach($posts as $post)
      <li class="bg-white dark:bg-gray-800 rounded-lg shadow-xl">
          <a href=" {{route('posts.show')->$slug}} " class="group max-w-sm mx-auto overflow-hidden bg-white rounded-lg hover:shadow-lg dark:bg-gray-800 hover:bg-gray-200 transition duration-500 ease-in-out">
            <img
